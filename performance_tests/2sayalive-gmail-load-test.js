...
export function handleSummary(data) {
    ...
    data.testInfo = {
        ...
        description: 'Comprehensive test-5 event user journey with realistic data payloads including multipart form submissions, LeanX payment gateway integration, OAuth flows, and dynamic user data generation. Updated to match latest Gmail Grafana recording.',
        eventDetails: {
        ...
        features: [
            ...
            'LeanX payment gateway simulation',
